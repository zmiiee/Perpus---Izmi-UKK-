            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    <div class="card-body p-sm-5">
                        ...
                        <h4 class="fs-13 fw-bold mb-2">Login ke akun</h4>
                        <p class="fs-12 fw-medium text-muted">Selamat Datang. Silakan masuk ke akun Anda untuk melanjutkan.</p>
                        <form method="POST" action="{{ route('login.process') }}" class="w-100 mt-4 pt-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="auth-reset-minimal.html" class="fs-11 text-primary">Lupa password?</a>
                                </div>
                            </div>
                            <div class="mt-5">
